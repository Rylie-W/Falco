    ...
    showModalBottomSheet(
        ...
        builder: (BuildContext bc) {
          return new BottomSheetContent(
              (result) => _afterSendingData(result), _key);
        });
  }
  ...
  Widget _centerWidgetDecision() {
    if (_nothing) {
      return new AnimatedOpacity(
          opacity: _nothing ? 1.0 : 0.0,
          duration: Duration(seconds: 4),
          child: new Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                new Center(
                    child: new Image.asset("assets/graphics/question.png",
                        width: 100)),
                new Center(
                    child: new Padding(
                        padding: EdgeInsets.only(top: 20),
                        child: new Text(
                            "${MyLocalizations.of(context).trans("no_food")}",
                            style: TextStyle(
        ...
        builder: (BuildContext context) {
          return Theme(
            ...
            child: new AlertDialog(
              ...
              content: new Text(
                  "${MyLocalizations.of(context).trans("delete_question")} ${f.description} ?",
              ...
              actions: <Widget>[
                new FlatButton(
                    ...
                    child: new Text(
                        "${MyLocalizations.of(context).trans("remove")}"
                            .toUpperCase(),
                        style: TextStyle(color: Colors.red))),
                new FlatButton(
                    onPressed: () => Navigator.pop(context),
                    child: new Text(
                        "${MyLocalizations.of(context).trans("cancel")}"
                            .toUpperCase(),
        ...
        body: new Stack(children: <Widget>[
          new Column(mainAxisSize: MainAxisSize.max, children: <Widget>[
            new Padding(
                ...
                child: new Text(
                    MyLocalizations.of(context).trans('home_text_motivation'),
                    textAlign: TextAlign.left,
                    style: TextStyle(
                        fontSize: 30, color: Theme.of(context).accentColor)))
          ]),
          new Container(
              margin: EdgeInsets.only(top: 160), child: _centerWidgetDecision())
        ]));
  }
}
